...
class Patient(currentstatus.Status, clinicalhistory.ClinicalHistory):
    ...
    def patientmenu(found_patient):
        ...
        if (found_patient.Clinicalhistory.departure == None):
            print("Document: ", found_patient.document, " - Name: ",
                  found_patient.name, " - In the hospital: ", "Yes")
            ...
            print("Document: ", found_patient.document, " - Name: ",
                  found_patient.name, " - In the hospital: ", "No")
    ...
    def showdata(found_patient):
        ...
        print("Diagnostic image: ",
              found_patient.Clinicalhistory.Annexes.diagnosticimg)
...
patient_list.append(Patient(321, "Juan", 1, ['12', '12', '2003'], "A+", 1, currentstatus.Status(234, 32.3, 95, 23, 4), clinicalhistory.ClinicalHistory(['10', '8', '2023'], "Fever",
                    "Flu", "Paracetamol", "Paracetamol", clinicalhistory.Annexes("Se tomo el paracetamol pero no mejora, la vaina ta pelua", None, "Está bien maluco"), "Dr. Joao", None)))
patient_list.append(Patient(123, "Mathew", 1, ['17', '12', '2003'], "A+", None, currentstatus.Status(150, 35.5, 99, 14, 2), clinicalhistory.ClinicalHistory(['5', '9', '2023'], "Se sentia maluco",
                    "Esta maluco", "Acetaminofen y pa la casa", "Acetaminofen", clinicalhistory.Annexes("Se tomo la vaina y ya esta bacano", None, None),  "Dr. Joselui", ['5', '9', '2023'])))
