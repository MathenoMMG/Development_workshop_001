...
class Annexes():
    ...
    def sendannexes():
        ...
        x = int(
            input("There are diagnostic images in the clinical history? (Y = 1 / N = 2) "))
        if x == 1:
        ...
        x = int(
            input("There are examens results in the clinical history? (Y = 1 / N = 2) "))
        if x == 1:
...
class ClinicalHistory ():
    ...
    def newclinicalhistory():
        ...
        out = int(
            input("The patient is already out of the hospital? (Y = 1 / N = 2)"))
        if out == 1:
        ...
        recentclinicalhistory = ClinicalHistory(
            arrived, reason, diagnosis, treatment, medicament, annexes, doctor, departure)
