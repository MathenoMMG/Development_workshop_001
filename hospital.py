...
class Hospital(patient.Patient):
    ...
    def hospitalstatus():
        ...
        print("Number of patients in the hospital at the moment: ",
              (bedsocupied+chairsocupied))
        print("Number of beds free at the moment: ", fbeds)
        print("Number of chairs free at the moment: ", fchairs)
        print("Number of patients today in ",
              patienttodayin, "  - out ", patienttodayout)
        print("Number of patients in the current month in ",
              patientsmonthin, "  - out ", patientsmonthout)
        print("Number of patients that left the hospital in the current month: ")
        print("Hospital occupancy rate: ", ((bedsocupied+chairsocupied) /
              (NewHospital.beds+NewHospital.chairs))*100, "%")
    ...
    def hospitalpatients():
        ...
        for Patient in patient_list:
            ...
            print(x, ". Document:", Patient.document, " - Name: ", Patient.name, " - Sex: ", Patient.sex, " - BT: ", Patient.blood_type, " - Last Score: ",
                  Patient.Status.score, " - Last prescription: ", Patient.Clinicalhistory.medicament, " - Last Doctor: ", Patient.Clinicalhistory.doctor, " - In Hospital: ", gone)
            x += 1
